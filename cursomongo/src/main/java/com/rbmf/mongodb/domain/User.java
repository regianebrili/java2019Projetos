...
public class User implements Serializable{
	...
	@DBRef(lazy = true)		// referenciando outra coleção do MongoDB (lazy para não recuperar automaticamente a lista de posts, garante os que os posts serão carregados somente se acessá-los)
